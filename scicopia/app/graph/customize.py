...
KEY = "_key"  # find nodes in the legende, it is recomented to use _key
LABEL = (
    "name"  # represent nodes in the legende, example uses "name" (Africa, Asia, ...)
)
